...
export default function FileBrowser() {
  ...
  return (
    <div className="flex h-full">
      <div className="flex flex-col flex-1 min-w-0">
        <header className="flex items-center gap-3 px-6 py-3 border-b border-[var(--border)] flex-shrink-0">
          ...
          <select
            ...
            className="h-7 px-2 rounded-md bg-[var(--bg-tertiary)] border border-[var(--border)] text-xs text-[var(--text-secondary)] outline-none"
          >
      ...
      {selectedArtifact && (
        <div className="w-[360px] flex-shrink-0 border-l border-[var(--border)] bg-[var(--bg-secondary)]">
          <FilePreview
